...
<html lang="en">
   ...
   <body>
                  ...
                  <div class="col-sm-12">
                     <div class="custom_menu">
                        <ul>
                           ...
                           <li><a href="">Tavsiye Edilenler</a></li>
                           <li><a href="{{route('newrelease')}}">Yeni Ürünler</a></li>
                           <li><a href="{{route('todaysdeal')}}">Günün İndirimleri</a></li>
                           <li><a href="{{route('customerservice')}}">Destek & Talep</a></li>
                        </ul>
                     </div>
                  </div>
               </div>
               ...
               <div class="containt_main">
                  ...
                  <div class="header_box">
                     <div class="lang_box ">
                        ...
                        <img src ="{{ asset('home/images/flag-tr.png') }}" style="height: 16px;" alt="flag" class="mr-2 " title="United Kingdom"> Türkçe <i class="fa fa-angle-down ml-2" aria-hidden="true"></i>
                        </a>
                        <div class="dropdown-menu ">
                           <a href="#" class="dropdown-item">
                           <img src="{{ asset('home/images/flag-uk.png') }}" class="mr-2" alt="flag">
                           English
                           </a>
                        </div>
                     </div>
                     <div class="login_menu">
                        <ul>
                           ...
                           <li><a href="{{route('userprofile')}}">
                              ...
                              <span class="padding_10">Profil</span></a>
                           </li>
                        </ul>
                     </div>
                  </div>
         ...
         <div class="container">
            ...
            <div class="footer_menu">
               <ul>
                  ...
                  <li><a href="#">Günün İndirimleri</a></li>
                  <li><a href="#">Destek & Talep</a></li>
               </ul>
            </div>
            <div class="location_main">Destek Hattı : <a href="#">+90 532 532 5252</a></div>
         </div>
      </div>
      ...
      <div class="copyright_section">
         <div class="container">
            <p class="copyright_text">© 2020 All Rights Reserved. Design by <a href="https://html.design">E-Figür</a></p>
         </div>
      </div>
